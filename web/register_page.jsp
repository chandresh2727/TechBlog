...
<html>
    ...
    <body>
        ...
        <main class="primary-background p-5 banner-backgrond">
            <div class="container">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="reg-form" action="RegisterServlet" method="post">
                                <!--<a href="../src/java/com/tech/blog/servlets/RegisterServlet.java"></a>-->
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (data.trim() === 'done')
                            {
                                ...
                                swal("Registered succesfully... We are going ro redirect to login page")
                                        .then((value) => {
